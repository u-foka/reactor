...
class reactor
{
 ...
 private:
   ...
   ::iws::detail::might_shared_mutex _factory_mutex;
   ::iws::detail::might_shared_mutex _addon_mutex;
   ::iws::detail::might_shared_mutex _object_map_mutex;
...
T &reactor::get(const typed_contract<T> &contract)
{
   ...
   ::iws::detail::might_shared_lock<::iws::detail::might_shared_mutex> object_map_read_lock(_object_map_mutex);
   ...
   ::iws::detail::might_shared_lock<::iws::detail::might_shared_mutex> factory_read_lock(_factory_mutex);
